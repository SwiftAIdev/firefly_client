...
with firefly_client.ApiClient(configuration) as api_client:
    ...
    api_instance = firefly_client.TransactionsApi(api_client)
...
with firefly_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = firefly_client.TransactionsApi(api_client)
    transaction_store = firefly_client.TransactionStore() # TransactionStore | JSON array or key=value pairs with the necessary transaction information. See the model for the exact specifications.
    x_trace_id = 'x_trace_id_example' # str | Unique identifier associated with this request. (optional)
...
with firefly_client.ApiClient(configuration) as api_client:
    ...
    api_instance = firefly_client.TransactionsApi(api_client)
    id = '123' # str | The ID of the transaction.
    transaction_update = firefly_client.TransactionUpdate() # TransactionUpdate | JSON array with updated transaction information. See the model for the exact specifications.
    x_trace_id = 'x_trace_id_example' # str | Unique identifier associated with this request. (optional)
