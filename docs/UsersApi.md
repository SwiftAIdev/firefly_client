...
with firefly_client.ApiClient(configuration) as api_client:
    ...
    api_instance = firefly_client.UsersApi(api_client)
...
with firefly_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = firefly_client.UsersApi(api_client)
    user = firefly_client.User() # User | JSON array or key=value pairs with the necessary user information. See the model for the exact specifications.
    x_trace_id = 'x_trace_id_example' # str | Unique identifier associated with this request. (optional)
...
with firefly_client.ApiClient(configuration) as api_client:
    ...
    api_instance = firefly_client.UsersApi(api_client)
    id = '123' # str | The user ID.
    user = firefly_client.User() # User | JSON array with updated user information. See the model for the exact specifications.
    x_trace_id = 'x_trace_id_example' # str | Unique identifier associated with this request. (optional)
