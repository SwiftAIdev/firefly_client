...
class AccountStore(BaseModel):
    ...
    interest: Optional[StrictStr] = Field(default='0', description="Mandatory when type is liability. Interest percentage.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interest": obj.get("interest") if obj.get("interest") is not None else '0',
