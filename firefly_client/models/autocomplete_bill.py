...
class AutocompleteBill(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    name: StrictStr = Field(description="Name of the bill found by an auto-complete search.")
    active: Optional[StrictBool] = Field(default=None, description="Is the bill active or not?")
    __properties: ClassVar[List[str]] = ["id", "name", "active"]
