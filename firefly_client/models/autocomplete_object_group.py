...
class AutocompleteObjectGroup(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    title: StrictStr = Field(description="Title of the object group found by an auto-complete search.")
    name: StrictStr = Field(description="Title of the object group found by an auto-complete search.")
    __properties: ClassVar[List[str]] = ["id", "title", "name"]
