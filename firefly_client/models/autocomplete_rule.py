...
class AutocompleteRule(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    name: StrictStr = Field(description="Name of the rule found by an auto-complete search.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the rule found by auto-complete.")
