...
class AutocompleteTag(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    name: StrictStr = Field(description="Name of the tag found by an auto-complete search.")
    tag: StrictStr = Field(description="Name of the tag found by an auto-complete search.")
