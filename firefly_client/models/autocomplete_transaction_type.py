...
class AutocompleteTransactionType(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    name: StrictStr = Field(description="Type of the object found by an auto-complete search.")
    type: StrictStr = Field(description="Name of the object found by an auto-complete search.")
