...
class BasicSummaryEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "title", "monetary_value", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "value_parsed", "local_icon", "sub_title"]
