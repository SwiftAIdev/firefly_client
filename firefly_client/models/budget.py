...
class Budget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "name", "active", "notes", "order", "auto_budget_type", "auto_budget_currency_id", "auto_budget_currency_code", "auto_budget_amount", "auto_budget_period", "spent"]
