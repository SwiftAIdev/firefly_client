...
class BudgetSpent(BaseModel):
    ...
    BudgetSpent
    """ # noqa: E501
    sum: Optional[StrictStr] = Field(default=None, description="The amount spent.")
    ...
    __properties: ClassVar[List[str]] = ["sum", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places"]
