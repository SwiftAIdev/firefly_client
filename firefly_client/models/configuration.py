...
class Configuration(BaseModel):
    ...
    editable: StrictBool = Field(description="If this config variable can be edited by the user")
    __properties: ClassVar[List[str]] = ["title", "value", "editable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "value": PolymorphicProperty.from_dict(obj["value"]) if obj.get("value") is not None else None,
