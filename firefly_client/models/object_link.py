...
class ObjectLink(BaseModel):
    ...
    ObjectLink
    """ # noqa: E501
    var_0: Optional[ObjectLink0] = Field(default=None, alias="0")
    var_self: Optional[StrictStr] = Field(default=None, alias="self")
    __properties: ClassVar[List[str]] = ["0", "self"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "0": ObjectLink0.from_dict(obj["0"]) if obj.get("0") is not None else None,
            "self": obj.get("self")
        })
        return _obj
