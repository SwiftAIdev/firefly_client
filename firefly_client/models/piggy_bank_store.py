...
class PiggyBankStore(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "account_id", "target_amount", "current_amount", "start_date", "target_date", "order", "active", "notes", "object_group_id", "object_group_title"]
