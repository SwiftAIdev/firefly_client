...
class PiggyBankUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "account_id", "currency_id", "currency_code", "target_amount", "current_amount", "start_date", "target_date", "order", "active", "notes", "object_group_id", "object_group_title"]
