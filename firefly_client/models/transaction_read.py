...
class TransactionRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": Transaction.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "links": ObjectLink.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
