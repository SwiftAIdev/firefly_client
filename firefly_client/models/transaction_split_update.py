...
class TransactionSplitUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["transaction_journal_id", "type", "date", "amount", "description", "order", "currency_id", "currency_code", "currency_symbol", "currency_name", "currency_decimal_places", "foreign_amount", "foreign_currency_id", "foreign_currency_code", "foreign_currency_symbol", "foreign_currency_decimal_places", "budget_id", "budget_name", "category_id", "category_name", "source_id", "source_name", "source_iban", "destination_id", "destination_name", "destination_iban", "reconciled", "bill_id", "bill_name", "tags", "notes", "internal_reference", "external_id", "external_url", "bunq_payment_id", "sepa_cc", "sepa_ct_op", "sepa_ct_id", "sepa_db", "sepa_country", "sepa_ep", "sepa_ci", "sepa_batch_id", "interest_date", "book_date", "process_date", "due_date", "payment_date", "invoice_date"]
