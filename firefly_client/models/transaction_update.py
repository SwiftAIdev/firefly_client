...
class TransactionUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apply_rules", "fire_webhooks", "group_title", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [TransactionSplitUpdate.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
