...
class TestAccountRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountRead:
        """Test AccountRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountRead`
        """
        model = AccountRead()
        if include_optional:
            return AccountRead(
