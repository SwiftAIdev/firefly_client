...
class TestAutocompleteRuleGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutocompleteRuleGroup:
        """Test AutocompleteRuleGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutocompleteRuleGroup`
        """
    ...
    def testAutocompleteRuleGroup(self):
        """Test AutocompleteRuleGroup"""
