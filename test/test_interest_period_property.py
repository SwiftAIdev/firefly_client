...
class TestInterestPeriodProperty(unittest.TestCase):
    """InterestPeriodProperty unit test stubs"""
    ...
    def testInterestPeriodProperty(self):
        """Test InterestPeriodProperty"""
        # inst = InterestPeriodProperty()
