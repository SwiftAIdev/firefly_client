...
class TestRuleSingle(unittest.TestCase):
    """RuleSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RuleSingle:
        """Test RuleSingle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RuleSingle`
        """
        model = RuleSingle()
        if include_optional:
            return RuleSingle(
                data = firefly_client.models.rule_read.RuleRead(
                    type = 'rules', 
                    id = '2', 
