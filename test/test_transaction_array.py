...
class TestTransactionArray(unittest.TestCase):
    """TransactionArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionArray:
        """Test TransactionArray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionArray`
        """
        model = TransactionArray()
        if include_optional:
            return TransactionArray(
                data = [
                    firefly_client.models.transaction_read.TransactionRead(
                        type = 'transactions', 
                        id = '2', 
