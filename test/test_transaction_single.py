...
class TestTransactionSingle(unittest.TestCase):
    """TransactionSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionSingle:
        """Test TransactionSingle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionSingle`
        """
        model = TransactionSingle()
        if include_optional:
            return TransactionSingle(
                data = firefly_client.models.transaction_read.TransactionRead(
                    type = 'transactions', 
                    id = '2', 
                    attributes = firefly_client.models.transaction.Transaction(
                        created_at = '2018-09-17T12:46:47+01:00', 
                        updated_at = '2018-09-17T12:46:47+01:00', 
                        user = '3', 
                        group_title = 'Split transaction title.', 
                        transactions = [
                            firefly_client.models.transaction_split.TransactionSplit(
                                user = '3', 
    ...
    def testTransactionSingle(self):
        """Test TransactionSingle"""
