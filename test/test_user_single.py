...
class TestUserSingle(unittest.TestCase):
    """UserSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSingle:
        """Test UserSingle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSingle`
        """
        model = UserSingle()
        if include_optional:
            return UserSingle(
                data = firefly_client.models.user_read.UserRead(
                    type = 'users', 
                    id = '2', 
